...
CellType='Fibroblast'   #types of cells in the screen. Used mainly in the segmentation portion. Inputs: 'Neuron', 'iPSC'
...
ScaleFEx_class.ScaleFEx(path_to_images,saving_folder=saving_folder,experiment_name=experiment_name,
                        ...
                        img_size=image_size,parallel=parallel,SaveImage=SaveImage,stack=stack, mag=magnification, 
                        CellType=CellType,MitoCh=MitoCh,RNAch=RNAch,downsampling=downsampling,)
